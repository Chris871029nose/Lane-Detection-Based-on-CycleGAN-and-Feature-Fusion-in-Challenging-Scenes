...
class VOCAugDataSet(Dataset):
    def __init__(self, dataset_path='/home/user/Datasets/culane_f/trainA/list', data_list='train_gt', transform=None):
        ...
        with open(os.path.join(dataset_path, data_list + '.txt')) as f:
            ...
            for line in f:
                ...
                self.label_list.append(dataset_path.replace('trainA/list', '') + line.strip().split(" ")[1])
...
class VOCAugDataSet2(Dataset):
    def __init__(self, dataset_path='/home/user/Datasets/culane_f/trainB/list', data_list='train_gt', transform=None):
        ...
        with open(os.path.join(dataset_path, data_list + '.txt')) as f:
            ...
            for line in f:
                self.img.append(line.strip().split(" ")[0])
                self.img_list.append(dataset_path.replace('/list', '') + line.strip().split(" ")[0])
                self.label_list.append(dataset_path.replace('trainB/list', '') + line.strip().split(" ")[1])
                self.exist_list.append(np.array([int(line.strip().split(" ")[2]), int(line.strip().split(" ")[3]), int(line.strip().split(" ")[4]), int(line.strip().split(" ")[5])]))
