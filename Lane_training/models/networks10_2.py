...
class EffG(nn.Module):
    def __init__(self, input_nc, output_nc, path, norm_layer=nn.InstanceNorm2d):
        
        #assert(n_blocks >= 0)
        super(EffG, self).__init__()
        ...
        self.model1 = nn.Sequential(RG.features[0],
                                    ...
                                    RG.features[3],
                                    RG.features[4])                            
        self.model2 = RG.features[5]
        self.model3 = RG.features[6]
        self.model4 = RG.features[7]
        self.model5 = RG.features[8]
        self.model6 = RG.features[9]
...
class FTF(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.InstanceNorm2d, use_dropout=False, n_blocks=9, padding_type='reflect'):
        ...
        mult = 1
        self.layer1 = nn.Sequential(nn.Conv2d(24, int(ngf * mult / 4), kernel_size=3, stride=1, padding=1, bias=use_bias),
                                    nn.BatchNorm2d(int(ngf * mult / 4)),
                                    nn.LeakyReLU(0.2, True))
        
        mult = 2
        self.layer2 = nn.Sequential(nn.ConvTranspose2d(48, int(ngf * mult / 8),
                                                       kernel_size=3, stride=2,
                                                       padding=1, output_padding=1,
                                                       bias=use_bias),
        ...
        mult = 4
        self.layer3 = nn.Sequential(nn.ConvTranspose2d(96, int(ngf * mult / 16),
        ...
        self.layer4 = nn.Sequential(nn.ConvTranspose2d(96, int(ngf * mult / 16),
                                                       kernel_size=3, stride=4,
                                                       padding=0, output_padding=1,
                                                       bias=use_bias),
                                    nn.BatchNorm2d(int(ngf * mult / 16)),
        ...
        mult = 2
        self.layer5 = nn.Sequential(nn.ConvTranspose2d(48, int(ngf * mult / 8),
                                                       kernel_size=3, stride=2,
                                                       padding=1, output_padding=1,
                                                       bias=use_bias),
                                    nn.BatchNorm2d(int(ngf * mult / 8)),
        ...
        mult = 1
        self.layer6 = nn.Sequential(nn.Conv2d(24, int(ngf * mult / 4), kernel_size=3, stride=1, padding=1, bias=use_bias),
                                    nn.BatchNorm2d(int(ngf * mult / 4)),
                                    nn.LeakyReLU(0.2, True))
        '''
        mult = 2
