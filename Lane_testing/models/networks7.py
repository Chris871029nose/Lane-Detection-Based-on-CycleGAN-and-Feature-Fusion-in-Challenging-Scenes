...
class FTF(nn.Module):
    def __init__(self, input_nc, output_nc, path, ngf=64, norm_layer=nn.InstanceNorm2d, use_dropout=False, n_blocks=9, padding_type='reflect'):
        ...
        self.layer8 = nn.Sequential(nn.Conv2d(ngf * mult*2, 12, kernel_size=1, stride=1, padding=0, bias=use_bias),
                                    nn.BatchNorm2d(12),
                                    nn.LeakyReLU(0.2, True))
                                    
        self.layer9 = nn.Sequential(nn.Conv2d(ngf * mult*2, 44, kernel_size=1, stride=1, padding=0, bias=use_bias),
                                    nn.BatchNorm2d(44),
                                    nn.LeakyReLU(0.2, True))                            
...
class Encoder3(nn.Module):
    def __init__(self, num_classes):
        ...
        self.initial_block = DownsamplerBlock(3, 4)
        self.initial_block2 = DownsamplerBlock(16, 20)
