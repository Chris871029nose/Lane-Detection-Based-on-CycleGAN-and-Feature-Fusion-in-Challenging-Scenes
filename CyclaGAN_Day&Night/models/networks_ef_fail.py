...
class FusedMBConvConfig(_MBConvConfig):
    ...
    def __init__(
        ...
        if block is None:
            block = FusedMBConv
        #super(FusedMBConvConfig, self).__init__(expand_ratio, kernel, stride, input_channels, out_channels, num_layers, block)
        #super().__init__(expand_ratio=expand_ratio, kernel=kernel, stride=stride, input_channels=input_channels, out_channels=out_channels, num_layers=num_layers, block=block)        
        #super().__init__(expand_ratio, kernel, stride, input_channels, out_channels, num_layers, block)
        super().__init__(num_layers=2)

        
class DeFusedMBConvConfig(_MBConvConfig):
    # Stores information listed at Table 4 of the EfficientNetV2 paper
    def __init__(
        self,
        expand_ratio: float,
...
class DeConv2dNormActivation(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, 
        ...
        super(DeConv2dNormActivation, self).__init__()
...
def _efficientnet_conf(
    arch: str,
    **kwargs: Any,
) -> Tuple[Sequence[Union[MBConvConfig, FusedMBConvConfig,DeFusedMBConvConfig]], Optional[int]]:
    inverted_residual_setting: Sequence[Union[MBConvConfig, FusedMBConvConfig]]
