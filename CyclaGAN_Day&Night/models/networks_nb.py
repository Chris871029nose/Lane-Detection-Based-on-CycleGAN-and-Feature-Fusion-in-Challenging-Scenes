...
def define_G2(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netG == 'resnet_9blocks':
        #net = ResG(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9)
...
class ResG(nn.Module):
    ...
    def forward(self, input):
        ...
        output7 = self.model7(output6)
        print(output1.size(),output2.size(),output3.size(),output4.size(),output5.size(),output6.size(),output7.size())
